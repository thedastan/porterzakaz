...
const Header = () => {
  ...
  return (
    <Box
      ...
      w="100%"
      bg={{ base: isOpen ? "none" : "none", md: "white" }}
      py={4}
    >
      <div className="container">
        ...
        >
          ...
          >
            ...
            >
              {nav.map((el, index) => (
                <Link key={index} href={el.path} border="none" textDecor="none">
                  {el.name}
                </Link>
              ))}
            </Box>
            ...
            >
              {num.map((el, index) => (
                <Link key={index} href={el.link} textDecor="none">
                  <Flex
                    borderRadius={10}
                    gap={4}
                    bg="white"
          ...
          >
            ...
            <Box>
              ...
              <Link href={`tel:${PHONE_NUMBER_BILAIN}`}>
                <Text color="black" fontSize={14} fontWeight={400}>
                  {PHONE_NUMBER_BILAIN}
                </Text>
              </Link>
